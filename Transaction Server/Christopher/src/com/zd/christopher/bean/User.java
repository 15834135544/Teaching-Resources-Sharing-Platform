...
import com.zd.christopher.validator.LoginValidator.ILoginValidator;
...
public class User extends Entity
{
	...
	private Integer id;
	@NotBlank(groups={ILoginValidator.class}, message="User.userId is blank.")
	@Email(groups={ILoginValidator.class}, message="User.email is not valid.")
	private String userId;
	private transient String pwd;
	private String userName;
	@NotBlank(groups={ILoginValidator.class}, message="User.userName is blank.")
	@Length(groups={ILoginValidator.class}, min=16, max=16, message="Length of User.encryptedPwd is not 16.")
