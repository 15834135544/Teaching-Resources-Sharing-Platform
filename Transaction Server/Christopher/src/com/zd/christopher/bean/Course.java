...
public class Course extends Entity
{
	...
	public static Course toJson(Course course)
	{
		...
		if(tempCourse.getFaculty() != null)
			{
				jsonCourse.faculty.setId(tempCourse.getFaculty().getId());
				jsonCourse.faculty.setFacultyName(tempCourse.getFaculty().getFacultyName());
				jsonCourse.faculty.setImage(tempCourse.getFaculty().getImage());
			}
		...
		for(Document courseDocument : tempCourse.getDocument())
		{
			...
			document.setDocumentName(courseDocument.getDocumentName());
			User user = new User();
			user.setUserId(courseDocument.getAuthor().getUserId());
			user.setUserName(courseDocument.getAuthor().getUserName());
			document.setAuthor(user);
			document.setUrl(courseDocument.getUrl());
			document.setImage(courseDocument.getImage());
			document.setType(courseDocument.getType());
			document.setUpdatedTime(courseDocument.getUpdatedTime());
		...
		for(Video courseVideo : tempCourse.getVideo())
		{
			...
			video.setVideoName(courseVideo.getVideoName());
			User user = new User();
			user.setUserId(courseVideo.getAuthor().getUserId());
			user.setUserName(courseVideo.getAuthor().getUserName());
			video.setAuthor(user);
			video.setUrl(courseVideo.getUrl());
			video.setImage(courseVideo.getImage());
			video.setType(courseVideo.getType());
			video.setUpdatedTime(courseVideo.getUpdatedTime());
